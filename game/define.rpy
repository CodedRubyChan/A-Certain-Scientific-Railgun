...
define shiraiKuroko = Character("Kuroko Shirai")
define rowdyA = Character("Rowdy A")
define rowdyB = Character("Rowdy B")
define rowdyC = Character("Rowdy C")
define rowdyD = Character("Rowdy D")
...
define moveLong = MoveTransition(1.0)